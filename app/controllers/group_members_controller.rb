class GroupMembersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group_member.save
        format.html { redirect_to Group.find($current_group_id), notice: 'Group member was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @group_member.update(group_member_params)
        format.html { redirect_to Group.find($current_group_id), notice: 'Group member was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to Group.find($current_group_id), notice: 'Group member was successfully destroyed.' }
