...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { course_id: @alumno.course_id, user_id: @alumno.user_id } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { course_id: @alumno.course_id, user_id: @alumno.user_id } }
