...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { course_id: @profesor.course_id, user_id: @profesor.user_id } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { course_id: @profesor.course_id, user_id: @profesor.user_id } }
