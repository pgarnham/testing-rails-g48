...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post mensajes_url, params: { mensaje: { autor: @mensaje.autor, contenido: @mensaje.contenido, receptor: @mensaje.receptor } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { autor: @mensaje.autor, contenido: @mensaje.contenido, receptor: @mensaje.receptor } }
